...
namespace NetScript.Compilation.AST
{
    ...
    public class ShiftLeftAST : BinaryOperationAST
    {
        public ShiftLeftAST(ASTBase a, ASTBase b) : base(a, b) { }
        public override string ToString() => $"({A} << {B})";
        public override void Compile(BinaryWriter writer, CompilerArgs args) =>
            CompileAB(Bytecode.ShiftLeft, writer, args);
    }

    public class ShiftRightAST : BinaryOperationAST
    {
        public ShiftRightAST(ASTBase a, ASTBase b) : base(a, b) { }
        public override string ToString() => $"({A} >> {B})";
        public override void Compile(BinaryWriter writer, CompilerArgs args) =>
            CompileAB(Bytecode.ShiftRight, writer, args);
    }
